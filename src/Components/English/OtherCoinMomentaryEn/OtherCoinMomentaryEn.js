...
import { MomentaryDataJsx } from "./MomentaryDataEn";
import { Carousel } from "react-responsive-carousel";
import "react-responsive-carousel/lib/styles/carousel.min.css";
import "./OtherCoinMomentaryEn.css";

function OtherCoinMomentaryEn() {
  let sliceStart = 0;
                ...
                >
                  ...
                  <div className="coin-tether-price">
                    <span className="text-2sm">
                      {coinData.tetherPrice.toLocaleString()} Tether
                    </span>
                    <span className="text-xs opacity-70 font-semibold">
                      {coinData.tomanPrice.toLocaleString()} Toman
                    </span>
                  </div>
                </div>
              );
...
export default OtherCoinMomentaryEn;
